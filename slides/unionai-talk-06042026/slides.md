---
theme: seriph
title: UnionAI Talk 06-04-2026 · Container-enabled Asyncio is All You Need
author: Niels Bantilan @ Union.ai
titleTemplate: '%s | UnionAI Talk 06-04-2026'
info: |
  ## UnionAI Talk 06-04-2026 · ~25 min + ~5 min Q&A
...
:global(h1), :global(h2), :global(h3) { color: #FDB51F !important; }
:global(.slidev-layout.cover h1),
:global(.slidev-layout.intro h1) { color: #FDB51F !important; }
...
<h3 style="text-align: center !important;">Niels Bantilan · UnionAI Talk 06-04-2026</h3>

<br>

<img src="https://www.union.ai/docs/v2/union/images/icon-logo.svg" alt="Pycon logo" width="100" style="margin-left: auto; margin-right: auto;" />
...
<div>
  ...
  <div class="grid grid-cols-10 gap-y-1 font-medium">
    <div class="col-start-1 col-end-5 row-start-1 h-7 bg-sky-400 border border-sky-600 flex items-center justify-center px-2">boil water</div>
    <div class="col-start-2 col-end-4 row-start-2 h-7 bg-amber-400 border border-amber-600 flex items-center justify-center px-2">chop garlic + tomatoes</div>
    <div class="col-start-5 col-end-9 row-start-3 h-7 bg-sky-500 border border-sky-600 flex items-center justify-center px-2">cook pasta</div>
    <div class="col-start-4 col-end-9 row-start-4 h-7 bg-amber-500 border border-amber-600 flex items-center justify-center px-2">cook sauce</div>
    <div class="col-start-9 col-end-11 row-start-5 h-7 bg-emerald-400 border border-emerald-600 flex items-center justify-center px-2">mix</div>
  </div>
</div>
...
<div>
  ...
  <div class="grid grid-cols-10 gap-y-1 font-medium">
    <div class="col-start-1 col-end-11 row-start-1 h-7 bg-rose-400 border border-rose-600 flex items-center justify-center">cook 1: full spaghetti workflow</div>
    <div class="col-start-1 col-end-11 row-start-2 h-7 bg-rose-400 border border-rose-600 flex items-center justify-center">cook 2: full spaghetti workflow</div>
    <div class="col-start-1 col-end-11 row-start-3 h-7 bg-rose-400 border border-rose-600 flex items-center justify-center">cook 3: full spaghetti workflow</div>
  </div>
</div>
